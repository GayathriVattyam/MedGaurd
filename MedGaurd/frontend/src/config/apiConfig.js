// API Configuration
const API_BASE_URL = import.meta.env.VITE_API_URL || "https://medgaurd-4jk8.onrender.com";
...
export const API_ENDPOINTS = {
  ...
  ML_SYMPTOMS: `${ML_API_URL}/symptoms`,
...
export const ERROR_MESSAGES = {
  ...
  ML_API_DOWN: "Disease prediction service is offline. Please ensure Flask server is running on port 5001.",
};
...
export const getErrorMessage = (error) => {
  ...
  switch (error.response?.status) {
    case HTTP_STATUS.BAD_REQUEST:
      return error.response.data?.error || ERROR_MESSAGES.INVALID_REQUEST;
